  ...
  Tyre_Description: {
    ...
    properties: {
      Laden: {
        ...
        units: { type: String, default: "Kg/cm2 /kpa /psi" },
      },
      Unladen_Driver: {
        value: { type: String, default: "" },
      ...
      Tyre_wheel_combinations_Sizes: {
        value: { type: String, default: "" },
        label: { type: String, default: "Tyre or wheel (rim) combinations Sizes" },
      },
  ...
  Front_Wheel_Rim: {
    ...
    properties: {
      ...
      BIS_License_Number_validity: {
        value: { type: String, default: "" },
        label: { type: String, default: "BIS License or TAC Number with its Validity" },
      },
  ...
  Front_Parking_Lamp_LED_Type: {
    ...
    properties: {
      ...
      Number_of_Front_parking_lamps_and_their_colour: {
        value: { type: String, default: "" },
        label: { type: String, default: "Number of Front Parking lamps and their colour" },
      },
    },
  },
...
const DirectionIndicatorLampSchema = mongoose.Schema({
  ...
  Rear_Direction_Indicator_Bulb_Type: {
    ...
    properties: {
      ...
      Flashing_Frequency: {
        value: { type: String, default: "" },
        label: { type: String, default: "Flashing Frequency of direction indicator ( No of flashes or minute )" },
      },
    },
  },
...
const BrakesSchema = mongoose.Schema({
  ...
  Parts_of_Brake_System: {
    ...
    properties: {
      Drawing_Brake_shoes: {
        value: { type: String, default: "" },
        label: { type: String, default: "Upload Drawing Showing the Brake shoes or pads Details" },
      },
      Linings_pads: {
        value: { type: String, default: "" },
        label: { type: String, default: "Linings or pads (Indicate make, grade of material or identification mark) " },
      },
      ...
      Front_rear_pads: {
        value: { type: String, default: "" },
        label: { type: String, default: "Front and rear pad or liner dimensions including Inner and Outer pads" },
      },
      Front_rear_braking: {
        value: { type: String, default: "" },
  ...
  ABS: {
    ...
    properties: {
      ...
      ID_ABS_Controller: {
        value: { type: String, default: "" },
        label: { type: String, default: "Identification number(ID) or  Part No of ABS Controller  " },
      },
    },
  },
  // Drawing: {
  ...
  Parking_Brake: {
    ...
    properties: {
      On_which_wheel_Parking_Brake_is_Acting: {
        value: { type: String, default: "" },
        label: { type: String, default: "On which wheel Parking Brake is Acting? " },
      },
      ...
      Parking_brake_is_actuated_or_controlled_by: {
        value: { type: String, default: "" },
        label: { type: String, default: "Parking brake is actuated or controlled by" },
      },
...
const SteeringSuspensionAntiTheftSchema = mongoose.Schema({
  ...
  Lock_Anti_theft_device: {
    ...
    properties: {
      Type_of_handle_Lock: {
        value: { type: String, default: "" },
        label: { type: String, default: "Select the Type of handle Lock or Anti Theft or Protective Device" },
      },
      Make_of_Anti_Theft_Device: {
        value: { type: String, default: "" },
        label: { type: String, default: "Make of Anti Theft or Protective Device" },
      },
    },
  },
})
  ...
  Dimension: {
    ...
    properties: {
      ...
      Unladen_weight_of_the_vehicle: {
        value: { type: String, default: "" },
        label: { type: String, default: "Unladen or Kerb weight of the vehicle" },
        units: { type: String, default: "Kg" }
      },
      Front_overhang: {
        value: { type: String, default: "" },
  ...
  HPoint: {
    ...
    properties: {
      ...
      Free_height_Passenger_Seat: {
        value: { type: String, default: "" },
        label: { type: String, default: "Free height over seating position (Head Room) from H point for Passenger Seat" },
        units: { type: String, default: "mm" }
      },
    },
  },
  ...
  Instrument_Cluster: {
    ...
    properties: {
      ...
      Method_of_speed_or_Drive_mechanism_utilized: {
        value: { type: String, default: "" },
        label: { type: String, default: "Method of speed sending or Drive mechanism utilized " },
      },
      Overall_transmission_ratio_or_wheel_revolution: {
        value: { type: String, default: "" },
        label: { type: String, default: "Overall transmission ratio of the drive mechanism or pulse or wheel revolution " },
      },
  ...
  Critical_Electrical_Devices: {
    ...
    properties: {
      ...
      Identification_number_or_PartNo_or_DrawingNo: {
        value: { type: String, default: "" },
        label: { type: String, default: "Identification number(ID) or Part No. or Drawing No." },
      },
      ...
      Device_Name_Electrical_Components: {
        value: { type: String, default: "" },
        label: { type: String, default: "Device Name of Electrical Components" },
      },
      ...
      Identification_number_or_PartNo_or_DrawingNo_Electrical_Components: {
        value: { type: String, default: "" },
        label: { type: String, default: "Identification number(ID) or Part No. or Drawing No.(Electrical Components)" },
      },
    },
  },
})
