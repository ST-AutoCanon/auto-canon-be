...
const form1AData = mongoose.Schema({
    ...
    Coupling_devices: {
        ...
        properties: {
            Diagram_location_lighting: {
                label: { type: String, default: "Photograpth and/or drawings showing the position and construction of the coupling devices." },
                file_name: { type: String, default: "" },
            }
        }
    },
        ...
        properties: {
            Diagram_Stands_installation: {
                label: { type: String, default: 
                    `Drawing related to the stand installation showing minimum details given below, 
                    - Distance of median lateral plane from Front axle
                    - Location of installation of Prop stand (side stand) and Center stand from front axle
                    Angle between vehicle longitudinal median plane and prop stand in-use position`
                },
                file_name: { type: String, default: "" },
            },
    ...
    Rear: {
        ...
        properties: {
            Coordinates_of_drawing: {
                label: { type: String, default: 
                    `Dimensional Drawing indicating installation details of reflective Tapes at front, Rear & side of the` },
                file_name: { type: String, default: "" },
            },
        }
    },
